<template>
    <ul class="nav border-bottom">
        ...
        <li class="nav-item">
            <router-link to="/prx/create" active-class="active fw-bolder" class="nav-link">Prx Create</router-link>
        </li>
        <li class="nav-item">
            <router-link to="/medicine/list/1" active-class="active fw-bolder" class="nav-link">Medicine</router-link>
        </li>
        <li class="nav-item">
    ...
    <div class="container-fluid stickDamnFooter">
